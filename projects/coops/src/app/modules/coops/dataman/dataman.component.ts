...
@Component({
  selector: 'app-dataman',
  templateUrl: './dataman.component.html',
  styleUrls: ['./dataman.component.scss']
})
export class DatamanComponent implements OnInit {
  baseModel: BaseModel;
  ...
  init() {
    ...
    this.baseModel.breadCrumbItems = this.svPage.setBreadCrumbs(USER_STEP_MODEL.controller, 'Dataman')
  ...
  setSearchQuery(dsEmittData: any) {
